<x-app-layout title="Home">
    <section>
        <div class=""
            style="margin: 0; padding: 300px 150px 150px 150px; background-image:  url('image/image.png'); background-size: cover; background-position: center; background-attachment: fixed; ">
            <div class="">

                <h2 style="color: white;">Selamat Datang Di Gracias Badminton Court</h2>
